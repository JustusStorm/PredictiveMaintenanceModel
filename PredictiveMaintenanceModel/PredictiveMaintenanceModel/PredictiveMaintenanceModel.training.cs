...
namespace PredictiveMaintenanceModel
{
    public partial class PredictiveMaintenanceModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=38,MinimumExampleCountPerLeaf=115,NumberOfTrees=685,MaximumBinCountPerFeature=1024,LearningRate=1F,FeatureFraction=0.435423372236196F,LabelColumnName=@"Machine failure",FeatureColumnName=@"Features"}), labelColumnName: @"Machine failure"))      
